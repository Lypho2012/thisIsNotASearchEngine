...
def create_point_cloud_combined(png, foreimage):
    ...
    points = [(x,y,random.randint(0,img2.width)) for y in range(0,img1.height,RESOLUTION_STEP) for x in range(0,img1.width,RESOLUTION_STEP) if img1.getpixel((x,y))[:3] != (255,255,255)]
